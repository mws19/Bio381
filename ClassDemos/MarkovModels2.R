# Uncertainty and stochastic environments in matrix models
# April 18, 2017
# MWS
...
# Transistion matrices in varying environments
...
mt <- matSeq(mG=mGood,mB=mBad,Times=100,pBad=0.2) # set up the matrices in each time
